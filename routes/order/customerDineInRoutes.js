...
const { scanTableQRCode, getTableMenu } = require("../../controllers/order/customerDineInController");
const {
    joinGroupSession,
    addItemToGroupCart,
    updateGroupCartItem,
...
router.patch("/group/:orderId/item/:itemId", identifyTenant, protect, updateGroupCartItem);
router.post("/group/:orderId/submit", identifyTenant, protect, submitGroupOrder);
