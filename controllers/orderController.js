...
const { ORDER_STATUS, ORDER_STATUS_TRANSITIONS, HTTP_STATUS } = require('../utils/const');
...
exports.getOrderDetails = async (req, res) => {
    try {
        ...
        if (order.customerId._id.toString() !== req.user._id.toString() && req.user.roleName !== 'admin') {
...
exports.trackOrder = async (req, res) => {
    try {
        ...
        const order = await Order.findById(req.params.orderId)
            .select('orderStatus estimatedDeliveryTime actualDeliveryTime createdAt orderItems restaurantId orderId');
